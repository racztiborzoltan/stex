...
use Stex\SimpleTemplateXsltProcessor;
use Stex\VariableList;

final class SimpleTemplateXsltProcessorTest extends TestCase
{

    /**
     * @var SimpleTemplateXsltProcessor
     */
    ...
    {
        $proc = new SimpleTemplateXsltProcessor();
    ...
    protected function _getSimpleTemplateXsltProcessor(): SimpleTemplateXsltProcessor
    {
    ...
    {
        $stex = $this->_getSimpleTemplateXsltProcessor();
    ...
    public function test_transformToUri()
    {
        ...
        $output_path = 'file://'.__DIR__.'/temp/SimpleTemplateXsltProcessor_test_transform_to_uri_output.xml';
