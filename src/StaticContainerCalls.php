...
/**
 * Class for static calling the stored container object
 *
 * @author Rácz Tibor Zoltán <racztiborzoltan@gmail.com>
 *
 */
abstract class StaticContainerCalls
{
    ...
    {
        $container_item_name = array_shift($args);
        return static::__callstatic($container_item_name, $args);
    }
